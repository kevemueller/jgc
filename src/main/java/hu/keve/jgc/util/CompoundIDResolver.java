 ...
 *
 */
public final class CompoundIDResolver extends IDResolver {
	private HashMap<String, Object> idToObjectMap = null;
	...
	public <T> T resolve(final Class<T> targetType, final String id1, final String id2) {
